...
dict(id="anxiety", cat="heart", label="Anxiety & worry", blurb="Racing thoughts, dread, the mind that won't settle",
     ...
     feelings=["anxious","anxiety","worried","worry","worrying","cant stop worrying","overthinking","overthink","racing thoughts","mind wont stop","restless","uneasy","nervous","on edge","panicking","panic","panic attack","dread","dreading","tense","stressed","stress","stressed out","pressure","cant relax","cant switch off","churning","knot in my stomach","what if","scared about the future","future","uncertain","uncertainty","insomnia","cant sleep from worry","spiralling","spiraling", "my head is a mess", "im a mess", "losing it", "going crazy", "losing my mind", "my chest is tight", "tight chest", "cant breathe", "no peace of mind", "my mind is not calm", "i want peace", "peace of mind", "sakinah", "tension", "in tension", "public speaking", "presentation", "speech tomorrow", "stage fright", "scared to speak", "cyberbullied", "adhd", "cant concentrate", "cant focus"]),
...
dict(id="anger", cat="heart", label="Anger", blurb="Rage, resentment, the urge to lash out",
     ...
     feelings=["angry","anger","furious","rage","raging","mad","livid","irritated","annoyed","frustrated","frustration","lost my temper","snapped","want to scream","want to lash out","resentful","resentment","bitter","bitterness","grudge","hate","i hate","seething","fuming","fed up","had enough","cant take it", "short tempered", "quick to anger", "snap at people", "lose my temper easily", "irritable"]),
...
dict(id="shame", cat="heart", label="Shame & guilt", blurb="When you cannot forgive yourself",
     ...
     feelings=["guilty","guilt","ashamed","shame","embarrassed","humiliated","regret","regretful","remorse","i messed up","i ruined it","my fault","blame myself","cant forgive myself","disgusted with myself","hate myself","dirty","unworthy","not good enough","let everyone down","disappointed in myself", "i relapsed", "relapsed again", "i keep relapsing", "addicted", "addiction", "im addicted", "cant stop", "porn", "pornography", "gambling", "drinking", "alcohol", "drugs", "smoking", "bad habit", "keep going back", "slipped again", "did it again", "cant quit", "riya", "showing off", "show off", "pride", "arrogance", "arrogant", "ego", "vanity", "two faced", "hypocrite", "feel like a hypocrite", "munafiq", "insincere", "backbiting", "backbit", "gossiped", "gossiping", "i lied", "told a lie", "slandered someone", "spoke badly about someone", "lied", "i told a lie", "proud", "boastful", "stingy", "stinginess", "miserly", "tight with money", "ungrateful", "judgemental", "judging others", "looking down on people", "lazy", "laziness", "procrastinating", "cant be bothered", "wasting time"]),
...
dict(id="distress", cat="hardship", label="Severe distress", blurb="The moment when everything presses in at once",
     ...
     feelings=["distress","distressed","crisis","emergency","disaster","catastrophe","calamity","desperate","desperation","urgent","help me","worst day","everything went wrong","falling apart","cant take anymore","rock bottom","darkest","hardest time","trial","tested","severe", "prison", "jail", "arrested", "locked up", "court tomorrow", "hearing tomorrow", "waiting for a verdict"]),
...
dict(id="poverty", cat="provision", label="Money & provision", blurb="When income is tight or uncertain",
     ...
     feelings=["poor","poverty","broke","no money","skint","cant afford","struggling financially","rizq","provision","sustenance","barely surviving","paycheck","rent","cant pay rent","food","feed my family","income","need money","tight month","expenses","cost of living", "evicted", "eviction", "landlord", "cant pay the bills", "bills", "no money for food", "behind on rent", "homeless", "losing my home", "repossession", "cant afford it", "struggling to pay", "barakah in money", "payday", "salary", "expensive", "short on money", "tight this month", "zakat", "zakah", "charity", "sadaqah", "giving charity", "inheritance", "tax", "crypto", "investment", "savings"]),
...
dict(id="parents", cat="people", label="Parents & family", blurb="Mothers, fathers, and those who raised you",
     ...
     feelings=["parents","my mother","my father","mum","mom","dad","family","family problems","argument with family","estranged","dua for my parents","my parents are old","caring for parents","they passed away","honour my parents","siblings","brother","sister","in laws", "absent father", "absent parent", "estranged parent", "my mum", "my dad", "looking after my parents", "caring for my mum", "caring for my dad", "elderly parents", "dementia", "alzheimers", "caring for my mother", "caring for my father", "nursing home"]),
...
dict(id="reconcile", cat="people", label="Conflict with someone", blurb="Broken relationships and hard conversations",
     ...
     feelings=["argument","fight","fighting","fell out","not speaking","conflict","dispute","tension","awkward","apologise","apologize","forgive them","cant forgive","misunderstanding","difficult conversation","confront","make up","reconcile","friendship ended","lost a friend", "people gossip about me", "talking behind my back", "want to apologise", "how do i make peace", "estranged", "in laws", "my brother doesnt speak to me", "my sister doesnt speak to me", "family feud", "toxic family", "fell out with family", "friend stopped talking", "they blocked me", "fell out with a friend", "not on speaking terms", "silent treatment"]),
...
dict(id="desire", cat="faith", label="Desire & temptation", blurb="The wandering eye, the urge you are trying not to follow",
     ...
     feelings=["lust","lustful","desire","desires","tempted","temptation","urges","cant control myself","cant control my desire","struggling with desire","struggling with lust","porn","pornography","watching porn","addicted to porn","masturbation","masturbating","bad habit","secret sin","zina","adultery","fornication","haram relationship","girlfriend","boyfriend","talking to someone haram","attracted to someone","attracted to a coworker","i keep looking","cant stop looking","lower my gaze","lowering my gaze","wandering eye","modesty","chastity","staying chaste","want to stay pure","keep falling into the same sin","i keep relapsing","i cant stop","temptation is everywhere","dating","in a haram relationship","crush","i have a crush", "horny", "aroused", "turned on", "relapsed", "relapse", "slipped again", "gave in again", "cant help myself", "weak against it", "vaping", "betting", "gambling", "video games", "gaming", "cant stop gaming", "addicted to games", "gambling debt"]),
...
dict(id="refuge", cat="protection", label="Seeking refuge", blurb="Asking to be shielded from harm",
     ...
     feelings=["protection","protect me","seek refuge","refuge","keep me safe","safety","harm","danger","shield","cover","guard","watch over","travelling alone","walking home","at night","dark", "manzil", "ruqyah", "ruqya", "shifa", "protection verses", "haunted", "something in the house", "strange noises", "frightened at night", "lazy", "laziness", "incapacity"]),
...
dict(id="morning-evening", cat="daily", label="Morning & evening", blurb="How to begin and end a day",
     ...
     feelings=["morning","good morning","start of the day","waking up","woke up","evening","end of the day","night","adhkar","daily dhikr","routine","every day","beginning","fresh start","new day", "looking in the mirror", "new clothes", "got dressed", "yawning", "sneezing", "when someone sneezes", "entering the toilet", "leaving the toilet", "going to the bathroom", "waking up at night"]),
...
dict(id="prayer", cat="daily", label="In prayer", blurb="What is said within the ṣalāh",
     ...
     feelings=["prayer","salah","salat","namaz","praying","in sujood","prostration","ruku","after prayer","before prayer","tahajjud","night prayer","qiyam","witr","qunut","dua in prayer","fajr","concentration in prayer","khushu", "cant focus in salah", "distracted in prayer", "missed fajr", "missed prayers", "stopped praying"]),
...
dict(id="rain-weather", cat="daily", label="Rain, wind & sky", blurb="When the weather turns",
     ...
     feelings=["rain","raining","storm","thunder","lightning","wind","windy","weather","drought","flood","new moon","crescent","ramadan moon","looking at the sky","natural disaster","earthquake", "eclipse", "solar eclipse", "lunar eclipse", "kusuf", "khusuf", "hurricane", "cyclone", "typhoon", "tornado", "seeing the moon"]),
